...
;2.7	-includes patch code jumped to by the CCP to:
...
;	   Taken from Mike Douglas' 8MB FDC+ CP/M BIOS.
;2.8	-Expanded the Alocation Vectors to 512 bytes for BIG disks
;
;
...
;----------------------------;
CCPMOD          .EQU 1	     ; Enable CCP Patch Code
;----------------------------;
...
MSIZE		.EQU  59	;MEMORY SIZE IN KBYTES.
...
;       typed command if it fails to open on the default drive.
;----------------------------------------------------------------------------
CMDDRV  .EQU CCP+07F0h	;drive field used by the CCP
CMDTYPE .EQU CCP+07D6h	;file type in the FCB
USRNUM  .EQU CCP+0B41h	;user number in the BDOS

CCPCMD  .EQU CCP+06CDh	;CCP entry, try to open COM file
CCPERR  .EQU CCP+076Bh	;CCP entry, COM open failed
CCPOPEN .EQU CCP+00D0h	;CCP entry, open file in the FCB
CCPGO   .EQU CCP+06DEh	;CCP entry, execute opened COM file
CCPPRNT .EQU CCP+008Ch	;CCP entry, print A
